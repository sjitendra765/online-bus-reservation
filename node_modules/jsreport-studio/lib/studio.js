...
module.exports = function (reporter, definition) {
  ...
  function sendIndex (req, res, next) {
    ...
    function send (err, content) {
      ...
      if (req.originalUrl.indexOf('/studio') === -1) {
        content = content.replace('client.js', req.originalUrl + 'studio/assets/client.js')
      } else {
        content = content.replace('client.js', req.originalUrl.substring(0, req.originalUrl.indexOf('/studio')) + '/studio/assets/client.js')
      }
